...
def documents_page():
    ...
    if uploaded_file is not None:
        ...
        if st.button(
            ...
            if result:
                ...
                st.warning(
                    f"{uploaded_file.name} est déjà indexé. "
    ...
    if st.session_state.google_drive_service is None:
    ...
    # ------------------------------------------------------------
        ...
        service = st.session_state.google_drive_service
        ...
        if file_options:
            ...
            if st.button(
                ...
                try:
                    ...
                    file_content = service.download_file(
                        selected_file["id"]
                    )

                    # Send bytes directly to the existing
    ...
    if not st.session_state.confirm_clear_database:
        ...
        st.warning(
            "Vous êtes sur le point de supprimer tous "
            "les documents indexés. Cette action est "
            "irréversible. Confirmez-vous ?"
        )
